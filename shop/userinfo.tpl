<h1 class="title-1">Пользователь - {usertitle}</h1>
...
<h3 class="gp-title-1">Изменить информацию</h3>
...
<button class="button big color2" name="submit" type="submit">Сохранить изменения</button>
